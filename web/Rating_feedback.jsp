                ...
                <div class="container" >
                    ...
                    <div class="collapse navbar-collapse" id="MainNavBar">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <form action="RatingsFeed" method="post">
                    ...
                    <center>
                        ...
                        <table align="center" id="t01" >
                            ...
                            <c:forEach var="url" items="${result}" >
                                <tr>
                                    <td>
                                        <h4>  Give &nbsp ${url}&nbsp  Ratings </h4>
                                    </td>
                                    
                                    <td>
                                         
                                        <span style="padding-left:70px; ">
                                        <input type='text' name='rates' placeholder='Ratings from 0-10' />
                                        </span>
                                    ...
                                    <td>     
                                        <span style="padding-left:100px; ">
                                            ...
                                            <button class="btn btn-primary" style="background-color:  darkgreen"  name="call"  type="submit" value="${url}">Upload Ratings </button></span>
