                ...
                <div class="container" >
                    ...
                    <div class="collapse navbar-collapse" id="MainNavBar">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <form action="CheckResponse" method="post">
                    ...
                    <center>
                        ...
                        <table align="center" id="t01" >
                            ...
                            <c:forEach var="url" items="${result}" >
                                <tr>
                                    <td>
                                        <a  style="color:#357ae8;font-size: 17px;font-weight:bold " name="h" href="CheckCV?method=GET&input=${url}"> ${url}</a>
                                    </td>
                                    <td>     
                                        <span style="padding-left:100px; ">
                                            
                                            <button class="btn btn-primary" style="background-color:  darkgreen"  name="call"  type="submit" value="${url}">Send Call for interview</button></span>
                                    
                                    
                                    </td>
                                    
                                    <td>     
                                        <span style="padding-left:15px; "> <button class="btn btn-primary" style="background-color:  #a94442"  name="reject"  type="submit" value="${url}">Send Rejection Letter</button></span>
                                    </td>
